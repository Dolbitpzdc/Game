...
display_width = 800
display_height = 600
bg = pygame.image.load(resource_path(os.path.join('pigs','bg2.jpg')))
bg_2 = pygame.image.load(resource_path(os.path.join('pigs', 'bg.png')))
...
player_img = [pygame.image.load(resource_path(os.path.join('pigs', 'personage_2.1.png'))), pygame.image.load(resource_path(os.path.join('pigs', 'personage_2.1.png'))),
...
player_img2 = [pygame.image.load(resource_path(os.path.join('pigs', 'personage_1_right.png'))), pygame.image.load(resource_path(os.path.join('pigs', 'personage_1.2_right.png'))),
...
def question_1():
    ...
    if scores == 5 and 6:
        ...
        print_text('СТОП! Ты не побежишь дальше, пока не ответишь на вопрос!', 20, 50,  (23, 32, 42))
        print_text('В чем чаще всего измеряется кол-во информации?', 50, 90,  (23, 32, 42))
        print_text('A. Литры', 50, 130, (23, 32, 42))
        print_text('B. Байты', 50, 170,  (23, 32, 42))
        print_text('C. Метры', 50, 210,  (23, 32, 42))
...
def question_2():
    global scores
    if scores == 10:
        print_text("Стоп еще один вопрос!", 50, 50, (23, 32, 42))
        print_text("Сколько мегабайт в одном гигобайте?", 50, 90,  (23, 32, 42))
        print_text('A. 100', 50, 130,  (23, 32, 42))
        print_text('B.10000', 50, 170,  (23, 32, 42))
        print_text('C. 1000', 50, 210,  (23, 32, 42))
...
def question_3():
    ...
    if scores == 15:
        print_text("Стоп еще один вопрос!", 50, 50, (23, 32, 42))
        print_text("Посоянная память - это?", 50, 90,  (23, 32, 42))
...
def show_menu():
    ...
    while show:
        ...
        start_btn.draw(290, 290, "Start", startgame, 50)
