...
display_width = 800
display_height = 600
bg = pygame.image.load(resource_path(os.path.join('pigs','bg3.jpg')))
...
player_img = [pygame.image.load(resource_path(os.path.join('pigs', 'personage_1.png'))),
...
def show_menu():
    ...
    while show:
        ...
        start_btn.draw(290, 290, "Start", startgame2, 50)
